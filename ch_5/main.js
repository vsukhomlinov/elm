...
Elm.Direction.make = function (_elm) {
   ...
   if (_elm.Direction.values) return _elm.Direction.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var S = {ctor: "S"};
   var N = {ctor: "N"};
   var fromArrowKey = function (_p0) {
      var _p1 = _p0;
      var _p3 = _p1.y;
      var _p2 = _p1.x;
      return _U.eq(_p2,-1) ? $Maybe.Just(W) : _U.eq(_p2,
      1) ? $Maybe.Just(E) : _U.eq(_p3,
      -1) ? $Maybe.Just(S) : _U.eq(_p3,
      1) ? $Maybe.Just(N) : $Maybe.Nothing;
   };
   return _elm.Direction.values = {_op: _op
                                  ,fromArrowKey: fromArrowKey
                                  ,N: N
                                  ,S: S
                                  ,W: W
                                  ,E: E};
...
Elm.Utils.make = function (_elm) {
   ...
   var rect = function (_p0) {
      var _p1 = _p0;
      return A2($Svg.rect,
      _U.list([$Svg$Attributes.x($Basics.toString(A2(F2(function (x,
              y) {
                 return x * y;
              }),
              _p1._0,
              width)))
              ,$Svg$Attributes.y($Basics.toString(A2(F2(function (x,y) {
                 return x * y;
              }),
              _p1._1,
              height)))
...
Elm.Snake.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Direction = Elm.Direction.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var _op = {};
   var grow = function (model) {
      var cells = $List.reverse(model.cells);
      var tail = A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: 0,_1: 0},
      $List.head(cells));
      return _U.update(model,
      {cells: A2($List.append,model.cells,_U.list([tail]))});
   };
   var head = function (_p0) {
      var _p1 = _p0;
      var h = $List.head(_p1.cells);
      var _p2 = h;
      if (_p2.ctor === "Nothing") {
   ...
   var collides = function (model) {
      var tail$ = A2($Maybe.withDefault,
      _U.list([]),
      $List.tail(model.cells));
      var head$ = head(model);
      return A2($List.member,head$,tail$);
   };
   var view = function (model) {
      return A2($Svg.g,
      _U.list([]),
      A2($List.map,$Utils.rect,model.cells));
   };
   var cutOne = function (list) {
      return $List.reverse(A2($List.drop,1,$List.reverse(list)));
   };
   var newHead = F2(function (_p3,dir) {
      var _p4 = _p3;
      var _p7 = _p4._1;
      var _p6 = _p4._0;
      var _p5 = dir;
      switch (_p5.ctor)
      {case "N": return {ctor: "_Tuple2",_0: _p6,_1: _p7 - 1};
         case "S": return {ctor: "_Tuple2",_0: _p6,_1: _p7 + 1};
         case "W": return {ctor: "_Tuple2",_0: _p6 - 1,_1: _p7};
         default: return {ctor: "_Tuple2",_0: _p6 + 1,_1: _p7};}
   });
   var changeDirection = F2(function (from,to) {
      return _U.eq(from,$Direction.N) && _U.eq(to,
      $Direction.S) ? from : _U.eq(from,$Direction.S) && _U.eq(to,
      $Direction.N) ? from : _U.eq(from,$Direction.E) && _U.eq(to,
      $Direction.W) ? from : _U.eq(from,$Direction.W) && _U.eq(to,
      $Direction.E) ? from : to;
   });
   var update = F2(function (dir,model) {
      var newDir = function () {
         var _p8 = dir;
         if (_p8.ctor === "Nothing") {
               return model.dir;
            } else {
               return A2(changeDirection,model.dir,_p8._0);
            }
      }();
      var head$ = A2(newHead,
      A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: 0,_1: 0},
      $List.head(model.cells)),
      newDir);
      return _U.update(model,
      {dir: newDir
      ,cells: A2($List.append,_U.list([head$]),cutOne(model.cells))});
   });
   var Model = F2(function (a,b) {    return {cells: a,dir: b};});
   var init = F2(function (head$,length) {
      return A2(Model,
      A2($List.indexedMap,
      F2(function (i,_p9) {
         var _p10 = _p9;
         return {ctor: "_Tuple2",_0: _p10._0 - i,_1: _p10._1};
      }),
      A2($List.repeat,length,head$)),
      $Direction.E);
   });
...
Elm.Food = Elm.Food || {};
Elm.Food.make = function (_elm) {
   "use strict";
   _elm.Food = _elm.Food || {};
   if (_elm.Food.values) return _elm.Food.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Food = F2(function (a,b) {    return {point: a,seed: b};});
   var init = function (_p0) {
      ...
      $Random.initialSeed(A2(F2(function (x,y) {    return x + y;}),
      _p2,
      _p3)));
   };
   var update = F2(function (_p4,points) {
      var _p5 = _p4;
      var pointArray = $Array.fromList(points);
      var _p6 = A2($Random.generate,
      A2($Random.$int,0,$Array.length(pointArray)),
      _p5.seed);
      var randomIndex = _p6._0;
      var newSeed = _p6._1;
      var newPoint = A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: 0,_1: 0},
      A2($Array.get,randomIndex,pointArray));
      return A2(Food,newPoint,newSeed);
   });
   return _elm.Food.values = {_op: _op
                             ,init: init
                             ,update: update
                             ,Food: Food};
};
...
Elm.Board.make = function (_elm) {
   ...
   $Utils = Elm.Utils.make(_elm);
   var _op = {};
   var notMember = F2(function (list,el) {
      return $Basics.not(A2($List.member,el,list));
   });
   var freeCells = function (_p0) {
      var _p1 = _p0;
      var _p2 = _p1.size;
      var snakeCells = _p1.snake.cells;
      var maxX = A2(F2(function (x,y) {    return x - y;}),
      $Basics.fst(_p2),
      1);
      var maxY = A2(F2(function (x,y) {    return x - y;}),
      $Basics.snd(_p2),
      1);
      var allCells = $List.concat(A2($List.map,
      function (a) {
         return A2($List.map,
         function (b) {
      ...
      _U.range(0,maxY)));
      return A2($List.filter,notMember(snakeCells),allCells);
   };
   var view = function (game) {
      var pixelHeight = $Basics.toString(A2(F2(function (x,y) {
         return x * y;
      }),
      $Basics.snd(game.size),
      $Utils.height));
      var pixelWidth = $Basics.toString(A2(F2(function (x,y) {
         return x * y;
      }),
      $Basics.fst(game.size),
      $Utils.width));
      return A2($Html.div,
      ...
      _U.list([A2($Svg.svg,
      _U.list([$Svg$Attributes.width(pixelWidth)
              ,$Svg$Attributes.height(pixelHeight)
              ,$Svg$Attributes.viewBox($String.concat(_U.list(["0 0 "
                                                              ,pixelWidth
                                                              ," "
                                                              ,pixelHeight])))]),
      _U.list([$Snake.view(game.snake)
              ,$Utils.rect(game.food.point)]))]));
   };
   var End = {ctor: "End"};
   var Grow = {ctor: "Grow"};
   var None = {ctor: "None"};
   var update = F2(function (action,model) {
      var _p3 = action;
      if (_p3.ctor === "Step") {
            var _p4 = model.food.point;
            var fx = _p4._0;
            var fy = _p4._1;
            var newSnake = A2($Snake.update,_p3._0,model.snake);
            var _p5 = $Snake.head(newSnake);
            var x = _p5._0;
            var y = _p5._1;
            if (_U.cmp(x,0) < 0 || (_U.cmp(y,0) < 0 || (_U.cmp(x,
            $Basics.fst(model.size)) > -1 || (_U.cmp(y,
            $Basics.snd(model.size)) > -1 || $Snake.collides(newSnake)))))
            return {ctor: "_Tuple2",_0: model,_1: End}; else if (_U.eq(x,
               fx) && _U.eq(y,fy)) {
                     var food = A2($Food.update,model.food,freeCells(model));
                     return {ctor: "_Tuple2"
                            ,_0: _U.update(model,{snake: $Snake.grow(newSnake),food: food})
                            ,_1: Grow};
                  } else return {ctor: "_Tuple2"
                                ,_0: _U.update(model,{snake: newSnake})
                                ,_1: None};
         } else {
   ...
   var Board = F3(function (a,b,c) {
      return {snake: a,food: b,size: c};
   });
   var $new = function () {
      var food = $Food.init({ctor: "_Tuple2",_0: 2,_1: 7});
      var snake = A2($Snake.init,{ctor: "_Tuple2",_0: 3,_1: 5},3);
      return A3(Board,snake,food,{ctor: "_Tuple2",_0: 30,_1: 30});
   }();
...
Elm.Player.make = function (_elm) {
   ...
   var view = function (model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Html.text($String.concat(_U.list([model.name
                                                 ,": "
                                                 ,$Basics.toString(model.score)])))]));
   };
   var end = function (model) {    return model;};
   var score = function (model) {
      return _U.update(model,
      {score: A2(F2(function (x,y) {    return x + y;}),
      model.score,
      1)});
   };
...
Elm.Dialog.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F2(function (action,dialog) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Open": return _U.update(dialog,
           {open: true,score: _p0._0});
         case "Close": return _U.update(dialog,{open: false,score: 0});
         case "Input": return _U.update(dialog,{name: _p0._0});
         default: return _U.update(dialog,{open: false});}
   });
   var Submit = {ctor: "Submit"};
   var Input = function (a) {    return {ctor: "Input",_0: a};};
   var Close = {ctor: "Close"};
   var mailbox = $Signal.mailbox(Close);
   ...
   var view = F2(function (context,dialog) {
      ...
      _U.list([A2($Html.h3,
              ...
              _U.list([A2($Html.input,
                      ...
                      context.gameOver,
                      Save($Maybe.Just(A2($Player.Player,
                      dialog.name,
                      dialog.score))))]),
...
Elm.Main.make = function (_elm) {
   ...
   var Game = F5(function (a,b,c,d,e) {
      return {board: a,state: b,score: c,dialog: d,players: e};
   });
   var Chart = {ctor: "Chart"};
   ...
   var update = F2(function (event,game) {
      ...
      {case "Tick": if (_U.eq(game.state,Playing)) {
                 ...
                 {case "End": var newDialog = A2($Dialog.update,
                      ...
                      game.dialog);
                      return _U.update(newGame,{state: GameOver,dialog: newDialog});
                    case "Grow": return _U.update(newGame,
                      {score: A2(F2(function (x,y) {    return x + y;}),
                      game.score,
                      1)});
   ...
   var keyboard = Elm.Native.Task.make(_elm).performSignal("keyboard",
   A2($Signal.map,
   $Signal.send(gameMailbox.address),
   A2($Signal.map,
   Tick,
   A2($Signal.map,
      ...
      {case "Playing": return A2($Html.div,
           ...
           _U.list([A2($Html.div,
                   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                            ,_0: "text-align"
                                                            ,_1: "right"}]))]),
                   _U.list([$Html.text($String.concat(_U.list(["Score: "
   ...
   view,
   A3($Signal.foldp,update,newGame,gameMailbox.signal));
